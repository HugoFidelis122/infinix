...
export default function RootLayout({ children }: RootLayoutProps) {
  return (
    <Website>
      <Helmet>
        <title>Infinix APIs</title>
        <meta name="description" content="API de consultas cadastrais, veiculares e fotos para desenvolvedores. CPF, CNPJ, Placa, Chassi e mais." />
      </Helmet>
      <ScrollRestoration />
      <Header />
      {children}
